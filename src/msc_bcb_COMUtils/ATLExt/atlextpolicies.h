...
public:
	...
	static HRESULT GetSizeMax(T *pT, ULARGE_INTEGER *pcbSize, _MarshalInfo *pMshlInfo = NULL);
	static void init(T *pT) {*pT=NULL;}
	static void destroy(T *pT) {SysFreeString(*pT);}
}; // class _Persist<BSTR>
...
public:
	...
	static HRESULT Save(T *pT, LPSTREAM pStm, _MarshalInfo *pMshlInfo = NULL);
	static HRESULT GetSizeMax(T *pT, ULARGE_INTEGER *pcbSize, _MarshalInfo *pMshlInfo = NULL);
	static void init(T *pT) {VariantInit(pT);}
	static void destroy(T *pT) {VariantClear(pT);}
}; // class _Persist<VARIANT>
...
/*
template <>
inline HRESULT _Persist<BSTR>::Load(T *pT, LPSTREAM pStm)
{
...
template <>
inline HRESULT _Persist<BSTR>::Save(T *pT, LPSTREAM pStm, _MarshalInfo *pMshlInfo)	
{
...
template <>
inline HRESULT _Persist<BSTR>::GetSizeMax(T *pT, ULARGE_INTEGER *pcbSize, _MarshalInfo *pMshlInfo)	
{
	// Based on CComBSTR::WriteToStream.
	ATLASSERT(pT != NULL);
	ATLASSERT(pcbSize != NULL);
...
template <>
inline HRESULT _Persist<VARIANT>::Load(T *pT, LPSTREAM pStm)
{
...
template <>
inline HRESULT _Persist<VARIANT>::Save(T *pT, LPSTREAM pStm, _MarshalInfo *pMshlInfo)	
{
...
template <>
inline HRESULT _Persist<VARIANT>::GetSizeMax(T *pT, ULARGE_INTEGER *pcbSize, _MarshalInfo *pMshlInfo)	
{
	// Based on CComVariant::WriteToStream.
	ATLASSERT(pT != NULL);
	ATLASSERT(pcbSize != NULL);
