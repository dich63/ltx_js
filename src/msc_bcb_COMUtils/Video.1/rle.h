...
* Reentrant:   Yes
* $Id: rle.c,v 1.4 2004/12/25 19:27:04 marcus256 Exp $
*
...
inline static void _RLE_WriteRep( unsigned char *out, unsigned int *outpos,
...
inline static void _RLE_WriteNonRep( unsigned char *out, unsigned int *outpos,
...
template<class T>
 static unsigned  int compress( const T* in, T* out,
	 unsigned int insize )
	 {
	   return compress((const unsigned char *)in,(unsigned char *)out,insize);
	 };

template<class T>
 static unsigned  int decompress( const T* in, T* out, unsigned int insize )
 {
	 return uncompress((const unsigned char *)in,(unsigned char *)out,insize);
 };


static unsigned  int compress( const unsigned char *in, unsigned char *out,
    unsigned int insize )
{
...
static  unsigned int uncompress( const unsigned char *in, unsigned char *out,
    unsigned int insize )
{
