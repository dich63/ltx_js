...
{
     uint16_t mul; 
	filter_median_delta_t(int nthread,int _width,int _height,unsigned _mul=MUL,int _src_byte_width=0)
		:filter_base_t(nthread,_width,_height,_src_byte_width),mul(_mul){};
...
struct  filter_RGBA_t:filter_base_t<Ver>
{
	...
	filter_RGBA_t(int _nthread,int _width,int _height,int _src_byte_width=0,int _dest_byte_width=0)
		:filter_base_t(_nthread,_width,_height,_src_byte_width,_dest_byte_width),contour_level(-1)
	{
		//if(!src_byte_width) 
		src_byte_width=(_src_byte_width)?_src_byte_width:offsB*width;
		dest_byte_width=(_dest_byte_width)?_dest_byte_width:offsB*width;
