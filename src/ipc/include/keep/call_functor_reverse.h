...
struct invoker_base_t
{
	...
	inline 	R invoke(std::vector<arg_t>& args){ 
	...
	inline 	R invoke(int argc=0,arg_t* argv=0){ 
	...
	inline 	R invoke_proc(int argc,argh_t* argv){ return R();} 

	inline	R __invoke_proc(int argc=0,argh_t* argv=0)
	{
